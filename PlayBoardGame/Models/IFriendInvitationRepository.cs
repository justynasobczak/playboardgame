...
namespace PlayBoardGame.Models
{
    public interface IFriendInvitationRepository
    {
        ...
        bool IfInvitationWasReceivedByCurrentUser(string senderId, string currentUserEmail);
        int GetNumberOfPendingInvitationsForCurrentUser(string currentUserName);
    }
}